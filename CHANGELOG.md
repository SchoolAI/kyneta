# Unreleased (2.0)
  ...
  - **Why**: the upcoming establish-time `supportedProtocols` negotiation introduces a genuine *sync wire-contract revision* axis and needs the word "protocol" to mean exactly that; freeing the name before the 2.0 API freeze removes a permanent source of reader confusion.
